...
try:
  ...
  print "<label for=radio-flex>FLEX</label>"
  print "<input type=radio name=radio-pos id=radio-flex value=\"FLEX\" onclick=getStats()>"
  print "<label for=radio-all>ALL</label>"
  print "<input type=radio name=radio-pos id=radio-all value=\"ALL\" onclick=getStats()>"
  ...
  print "<th class=w3-centered>Team</th>"
  print "</tr>"
  print "</thead>"
