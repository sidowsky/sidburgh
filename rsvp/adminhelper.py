...
try:
  ...
  for row in results:
    ...
    if rsvp == -1:
      print "<td class=w3-centered><strong><font color=navy>N/A</font></strong></td>"
    elif rsvp == 0:
    ...
    if address != "":
      ...
      print "<td class=w3-centered>" + address  + "</td>"
